...
class IncidentReport(models.Model):
    ...
    reported_by = models.CharField(max_length=255) # Stores the email or name of the staff member
    created_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"{self.incident_type} - {self.student.full_name} ({self.incident_date})"